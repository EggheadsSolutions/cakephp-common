...
class Strings
{
     ...
     * @return bool
     */
    public static function startsWith(string $string, array|string $prefixes): bool
    {
     ...
     * @return bool
     */
    public static function endsWith(string $string, array|string $postfixes): bool
    {
     ...
     * @return string
     */
    public static function replaceIfStartsWith(string $string, array|string $prefixes, string $replacement = '', bool $concatOnFail = false): string
    {
        foreach ((array)$prefixes as $prefix) {
     ...
     * @return string
     */
    public static function replaceIfEndsWith(string $string, array|string $postfixes, string $replacement = '', bool $concatOnFail = false): string
    {
        foreach ((array)$postfixes as $postfix) {
